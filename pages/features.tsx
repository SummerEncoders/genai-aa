...
const features = [
  ...
  },
  {
    ...
    description:
      "Making the onboarding experience seamless with gasless transactions, users can skip the tedious process of obtaining network native tokens and instead focus.",
    icon: FaceSmileIcon,
  },
  {
    name: "Creator friendly",
    description:
      "Providing the creators and dreamers with a fast, free, and straightforward service.",
    icon: BoltIcon,
  },
  {
    name: "Powered by Arbitrum",
    description:
      "A suite of scaling solutions providing environments with high-throughput, backed by industry-leading proving technology rooter in Ethereum.",
    icon: BanknotesIcon,
  },
];
